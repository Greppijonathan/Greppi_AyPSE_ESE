...
// Dirección I2C por defecto del display OLED (0x3C o 0x3D según el hardware)
...
/**
 * @brief Callback de transmisión de bytes para u8g2 (ESP-IDF v6.x)
 */
...
esp_err_t board_init(void) {
    ...
    // 3. Registrar pantalla OLED en el bus I2C
    ...
    // 4. Inicializar u8g2 (Pantalla SSD1306 128x64)
    ...
    ESP_LOGI(TAG, "Hardware completo (I2C + MLX90614 + SSD1306) listo");
    return ESP_OK;
}
...
void board_mostrar_temperatura_oled(float temp) {
    ...
    u8g2_DrawStr(&u8g2, 10, 15, "PROYECTO AyPSE");
